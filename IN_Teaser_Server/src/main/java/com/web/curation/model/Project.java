...
public class Project {
	...
	public Project(int project_seq, int user_seq, String user_nickname, int portfolio_seq, String project_name,
	...
	public String toString() {
		return "Project [project_seq=" + project_seq + ", user_seq=" + user_seq + ", user_nickname=" + user_nickname
				+ ", portfolio_seq=" + portfolio_seq + ", project_name=" + project_name + ", project_intro="
				+ project_intro + ", project_start=" + project_start + ", project_end=" + project_end
				+ ", project_dev_setting=" + project_dev_setting + ", project_personnel=" + project_personnel
				+ ", project_position=" + project_position + ", project_content=" + project_content
				+ ", project_like_cnt=" + project_like_cnt + ", project_link=" + project_link + ", project_hashtag="
				+ project_hashtag + ", insert_date=" + insert_date + "]";
	}
